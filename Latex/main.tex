...
\HRule \\[0.4cm]
{ \huge \bfseries Emoji Stkire }\\ % Title of your document
\HRule \\[1.5cm]
...
\subsubsection{End User Criteria} % Sub-sub-section

\input{inputs/input1.txt}

%------------------------------------------------

\subsubsection{Maintenance Criteria} % Sub-sub-section

%----------------------------------------------------------------------------------------

\subsubsection{Performance Criteria} % Sub-sub-section

%----------------------------------------------------------------------------------------

\subsubsection{Trade Offs} % Sub-sub-section
...
\subsection{Detailed Object Design}
